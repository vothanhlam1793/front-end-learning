...
const messages = defineMessages({
  ...
  notPassingBody: {
    ...
    defaultMessage:
      'In order to qualify for a certificate, you must have a passing grade.',
  ...
  inProgressBody: {
    ...
    defaultMessage:
      'It looks like there is more content in this course that will be released in the future. Look out for email updates or check back on your course for when this content will be available.',
  ...
  requestableBody: {
    ...
    defaultMessage:
      'Congratulations, you qualified for a certificate! In order to access your certificate, request it below.',
  ...
  unverifiedPendingBody: {
    ...
    defaultMessage:
      'Your ID verification is pending and your certificate will be available once approved.',
    description:
      'Body text when learner certifcate status is unverified pending'
  },
  downloadableHeader: {
  ...
  notAvailableEndDateBody: {
    ...
    defaultMessage:
      'Final grades and any earned certificates are scheduled to be available after {endDate}.',
    description:
      'Shown for learners who have finished a course before grades and certificates are available.'
  },
  upgradeHeader: {
    id: 'progress.certificateStatus.upgradeHeader',
    defaultMessage: 'Earn a certificate',
    description:
      'Header text when the learner needs to upgrade to earn a certifcate '
  },
  upgradeBody: {
    id: 'progress.certificateStatus.upgradeBody',
    defaultMessage:
      'You are in an audit track and do not qualify for a certificate. In order to work towards a certificate, upgrade your course today.',
    description:
      'Body text when the learner needs to upgrade to earn a certifcate '
  },
  upgradeButton: {
    id: 'progress.certificateStatus.upgradeButton',
    defaultMessage: 'Upgrade now',
    description:
      'Button text which leaner needs to upgrade to get the certifcate'
  },
  unverifiedHomeHeader: {
    ...
    description:
      'Header text when the learner needs to do verification to earn a certifcate '
  },
  unverifiedHomeButton: {
    id: 'progress.certificateStatus.unverifiedHomeButton',
    defaultMessage: 'Verify my ID',
    description:
      'Button text which leaner needs to do verification to earn a certifcate'
  },
  unverifiedHomeBody: {
    id: 'progress.certificateStatus.unverifiedHomeBody',
    defaultMessage:
      'In order to generate a certificate for this course, you must complete the ID verification process.',
    description:
      'Body text when the learner needs to do verification to earn a certifcate'
  }
})
